...
```sh
cd src
em++ engine.cpp -o engine.js -s MODULARIZE=1 -s EXPORT_ES6=1 -s EXPORTED_FUNCTIONS='["_engine","_malloc","_free","_get_offset"]' -s EXPORTED_RUNTIME_METHODS='["HEAPU8","HEAP8","setValue","getValue"]' -s ENVIRONMENT=web --emit-tsd engine.d.ts
```
